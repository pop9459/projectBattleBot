...
void driveBySensors(byte speed);
...
void setMotorSpeed(int leftSpeed, int rightSpeed)
{
  ...
  if(leftSpeed != 0 && leftSpeed < 128 && _currentLeftSpeed != leftSpeed) analogWrite(leftSpeed < 0 ? L_BWD : L_FWD, 255);
  if(rightSpeed != 0 && rightSpeed < 128 && _currentRightSpeed != rightSpeed) analogWrite(rightSpeed < 0 ? R_BWD : R_FWD, 255);
  delay(40);
